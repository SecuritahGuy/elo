#!/usr/bin/env python3
"""
Simple accuracy test for ELO predictions.
"""
        ...
        try:
            ...
            if total_predictions > 0:
                ...
                if confidence_scores:
                    ...
                    if high_conf_games:
                        high_conf_correct = sum(1 for i in high_conf_games 
                                              if (completed_2024.iloc[i]['home_score'] > completed_2024.iloc[i]['away_score']) == 
                                                 (confidence_scores[i] > 0.3 and completed_2024.iloc[i]['home_score'] > completed_2024.iloc[i]['away_score']))
...
def test_rating_stability():
    ...
    for config_name, config in configs.items():
        ...
        try:
            ...
            ratings = interface.get_team_ratings()
...
if __name__ == "__main__":
    print("🏈 SIMPLE ELO ACCURACY TEST")
    print("="*50)
